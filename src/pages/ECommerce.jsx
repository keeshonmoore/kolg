  ...
  return (
    <div className="min-h-screen pt-20 bg-dark relative overflow-hidden">
      ...
      <div className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        >
          <source
            src="https://assets.mixkit.co/videos/preview/mixkit-online-shopping-on-a-laptop-39821-large.mp4"
            type="video/mp4"
          />
        ...
        <div className="website-creation-section grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <p className="text-lg text-secondary mb-6">
              We create feature-rich e-commerce platforms that drive sales and 
              provide exceptional shopping experiences. From small stores to 
              enterprise solutions, we've got you covered.
            </p>
            <div className="flex flex-wrap gap-4">
              {['Mobile-First Design', 'Secure Payments', 'Inventory Management'].map((feature, idx) => (
                <div
                  key={idx}
            ...
            {[
              {
                ...
                description: 'Custom e-commerce solutions built to your specifications and needs.',
              },
              {
              ...
              },
              {
                ...
                description: 'Data-driven insights to improve your store\'s performance.',
              },
            ].map((service, idx) => (
              <div
                key={idx}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="website-creation-card">
              ...
              <div className="space-y-8 relative">
                {[
                  { step: 'Store Planning', desc: 'Understanding your products and business goals.' },
                  { step: 'Design & Development', desc: 'Creating a beautiful, functional online store.' },
                  { step: 'Integration', desc: 'Setting up payment gateways and shipping solutions.' },
                  { step: 'Launch & Support', desc: 'Going live and providing ongoing maintenance.' },
                ].map((item, idx) => (
                  <div
                    key={idx}
        ...
        <div className="website-creation-section text-center relative py-16">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-secondary mb-8 max-w-2xl mx-auto">
              Let's build an e-commerce platform that drives sales and growth. Contact us to get started.
            </p>
            <Link
              to="/contact"
