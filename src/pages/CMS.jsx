      ...
      <div className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="text-xl md:text-2xl text-secondary max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>
            Powerful content management solutions to streamline your digital presence
          </p>
        </div>
      </div>
        ...
        <div className="website-creation-section grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <p className="text-lg text-secondary mb-6">
              We provide robust content management solutions that empower you to control 
              your digital content with ease. From WordPress to custom CMS platforms, 
              we've got you covered.
            </p>
            <div className="flex flex-wrap gap-4">
              {['User-Friendly Interface', 'Custom Solutions', 'Secure & Scalable'].map((feature, idx) => (
                <div
                  key={idx}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Expert WordPress development, customization, and optimization.',
              },
              {
                icon: 'fas fa-sync',
                title: 'Content Migration',
                description: 'Seamless transfer of content between different CMS platforms.',
              },
            ].map((service, idx) => (
              <div
                key={idx}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="website-creation-card">
              ...
              <div className="space-y-8 relative">
                {[
                  { step: 'Needs Assessment', desc: 'Understanding your content management requirements.' },
                  { step: 'Solution Design', desc: 'Creating the perfect CMS architecture for your needs.' },
                  { step: 'Development', desc: 'Building and customizing your CMS platform.' },
                  { step: 'Training & Support', desc: 'Ensuring your team can effectively use the system.' },
                ].map((item, idx) => (
                  <div
                    key={idx}
        ...
        <div className="website-creation-section text-center relative py-16">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-secondary mb-8 max-w-2xl mx-auto">
              Let's build a content management solution that works for you. Contact us to get started.
            </p>
            <Link
              to="/contact"
