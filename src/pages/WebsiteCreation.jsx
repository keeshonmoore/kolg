  ...
  return (
    <div className="min-h-screen pt-20 bg-dark relative overflow-hidden">
      ...
      <div className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        >
          <source
            src="https://assets.mixkit.co/videos/preview/mixkit-person-typing-on-a-computer-1371-large.mp4"
            type="video/mp4"
          />
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="text-xl md:text-2xl text-secondary max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>
            Custom-built, responsive websites tailored to your brand's unique vision
          </p>
        </div>
      </div>
        ...
        <div className="website-creation-section grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <p className="text-lg text-secondary mb-6">
              ...
              Our team combines cutting-edge technology with creative design to deliver websites that stand out.
            </p>
            <div className="flex flex-wrap gap-4">
              {['Responsive Design', 'Fast Loading', 'SEO Optimized'].map((feature, idx) => (
                <div
                  key={idx}
            ...
            {[
              {
                ...
                description: 'Tailored solutions built from scratch to meet your specific requirements and business goals.',
              },
              {
              ...
              },
              {
                ...
                description: 'Fast-loading websites with optimized code and assets for better user experience.',
              },
            ].map((service, idx) => (
              <div
                key={idx}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="website-creation-card">
              ...
              <div className="space-y-8 relative">
                {[
                  { step: 'Discovery & Planning', desc: 'Understanding your goals and creating a detailed project roadmap.' },
                  { step: 'Design & Prototyping', desc: 'Creating wireframes and design mockups for your approval.' },
                  { step: 'Development', desc: 'Building your website with clean, maintainable code.' },
                  { step: 'Testing & Launch', desc: 'Thorough testing and optimization before going live.' },
                ].map((item, idx) => (
                  <div
                    key={idx}
        ...
        <div className="website-creation-section text-center relative py-16">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-secondary mb-8 max-w-2xl mx-auto">
              Let's create something amazing together. Contact us to discuss your project and get started.
            </p>
            <Link
              to="/contact"
