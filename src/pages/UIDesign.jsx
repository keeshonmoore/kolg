  ...
  return (
    <div className="min-h-screen pt-20 bg-dark relative overflow-hidden">
      ...
      <div className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        >
          <source
            src="https://assets.mixkit.co/videos/preview/mixkit-designer-working-on-a-laptop-1371-large.mp4"
            type="video/mp4"
          />
        ...
        <div className="website-creation-section grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <p className="text-lg text-secondary mb-6">
              We craft beautiful, functional interfaces that prioritize user experience. 
              Our design process combines aesthetics with usability to create memorable digital experiences.
            </p>
            <div className="flex flex-wrap gap-4">
              {['User Research', 'Interactive Prototypes', 'Accessibility Focus'].map((feature, idx) => (
                <div
                  key={idx}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                title: 'Prototyping',
                description: 'Interactive prototypes to test and refine user experiences.',
              },
            ].map((service, idx) => (
              <div
                key={idx}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="website-creation-card">
              ...
              <div className="space-y-8 relative">
                {[
                  { step: 'Research & Discovery', desc: 'Understanding user needs and business goals.' },
                  { step: 'Wireframing', desc: 'Creating structural layouts and user flows.' },
                  { step: 'Visual Design', desc: 'Developing the visual language and interface.' },
                  { step: 'Testing & Iteration', desc: 'Refining designs based on user feedback.' },
                ].map((item, idx) => (
                  <div
                    key={idx}
        ...
        <div className="website-creation-section text-center relative py-16">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-secondary mb-8 max-w-2xl mx-auto">
              Let's create beautiful, user-friendly interfaces together. Contact us to discuss your project.
            </p>
            <Link
              to="/contact"
